    ...
    <div>
      <nav className='flex fixed h-24 w-full top-0 z-[9999] items-center justify-between flex-wrap bg-[#02030a] p-0 pr-10 lg:p-2'>
            ...
            <div className="flex h-16 items-center flex-shrink-0 text-white lg:mr-8">
                ...
                <span style={{fontFamily: "'Cinzel', serif"}} className="font-semibold italic text-xl tracking-tight hidden lg:block">Ocean's</span>
                <span style={{fontFamily: "'Cinzel', serif"}} className="font-semibold italic text-xl tracking-tight pt-10 -ml-10 hidden lg:block">Enigma</span>
            </div>
