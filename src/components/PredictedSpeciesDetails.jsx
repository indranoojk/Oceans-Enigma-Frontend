...
const PredictedSpeciesDetail = ({ prediction }) => {
//   const { species_name } = useParams();
  const species = speciesData.find((s) => s.species === prediction);
  // const { id } = useParams();
  ...
  return (
    <>
      <div className="py-10 px-28 bg-black text-white">
...
export default PredictedSpeciesDetail;
